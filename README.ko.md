...
가장 쉬운 방법은 [GitHub 최신 릴리스](https://github.com/himomohi/Codexy-pet-usages-ring/releases/latest)에서 `codex-pet-limit-rings-Win-0.1.20.zip`을 다운로드하고 일반 폴더에 압축을 푼 다음 `Install.bat` 또는 `Manage.bat`을 더블클릭하는 것입니다.
